...
// Convenience helpers for blog writing assistance
  ...
  const result = await chatCompletion([
    {
      role: "system",
      content:
        "You are a blog content categorizer. Suggest 3-6 relevant tags for a blog post. Return ONLY a JSON array of lowercase tag strings, nothing else. Example: [\"typescript\", \"nextjs\", \"web\"]",
    },
    {
      role: "user",
