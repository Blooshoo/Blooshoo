<script lang="ts">
import {
  createRevengeScene, updateRevengeScene, drawRevengeScene,
  type RevengeSceneState,
} from '$lib/scenes/revenge-scene';
import {
  createNeonField, updateNeonField, drawNeonField,
  type NeonFieldState,
} from '$lib/scenes/neon-field';
import {
  createSolarSystem, updateSolarSystem, drawSolarSystem,
  type SolarSystemState,
} from '$lib/scenes/solar-system-scene';
import {
  createGlobe, updateGlobe, drawGlobe,
  type GlobeState,
} from '$lib/scenes/globe-scene';
import {
  createAurora, updateAurora, drawAurora,
  type AuroraState,
} from '$lib/scenes/aurora-scene';
import {
  createSynthwave, updateSynthwave, drawSynthwave,
  type SynthwaveState,
} from '$lib/scenes/synthwave-scene';
import {
  createNeuralNet, updateNeuralNet, drawNeuralNet,
  type NeuralNetState,
} from '$lib/scenes/neural-scene';
...
<canvas bind:this={dropCanvas} class="fixed inset-0 z-20 pointer-events-none" aria-hidden="true"></canvas>